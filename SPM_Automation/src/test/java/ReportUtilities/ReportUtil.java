...
public class ReportUtil {
	...
	public static void startTesting(String filename, String testStartTime, String env, String rel) {
		...
		try {
			...
			out.write("<html>\n");
			out.write("<HEAD>\n");
			out.write(" <TITLE> SPM Test Automation Results </TITLE>\n");
			out.write("</HEAD>\n");

			out.write("<body>\n");
			out.write("<h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> SPM Test Automation Results </u></b></h4>\n");
			...
			out.write("<td width=150 align=left bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run Date</b></td>\n");
			out.write("<td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>" + RUN_DATE + "</b></td>\n");
			out.write("</tr>\n");
			out.write("<tr>\n");

			out.write("<td width=150 align=left bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run StartTime</b></td>\n");

			out.write("<td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>" + testStartTime + "</b></td>\n");
			out.write("</tr>\n");
			out.write("<tr>\n");
			// out.newLine();
			out.write("<td width=150 align= left  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Run EndTime</b></td>\n");
			out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>END_TIME</b></td>\n");
			out.write("</tr>\n");
			out.write("<tr>\n");
			// out.newLine();
			out.write("<td width=150 align= left  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Environment</b></td>\n");
			out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + ENVIRONMENT + "</b></td>\n");
			out.write("</tr>\n");
			out.write("<tr>\n");

			out.write("<td width=150 align= left  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Release</b></td>\n");
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<tr>\n");
			out.write("<td width=10%  align= center  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Script#</b></td>\n");
			out.write("<td width=40% align= center  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Case Name</b></td>\n");
			out.write("<td width=10% align= center  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Status</b></td>\n");
			out.write("<td width=20% align= center  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run Start Time</b></td>\n");
			out.write("<td width=20% align= center  bgcolor=#306791><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run End Time</b></td>\n");
	...
	public static void addTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status) {
		...
		try {
			...
			if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
				...
				out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> Detailed Report : Senior Prospect Management</h4>");
				out.write("<table  border=1 cellspacing=1    cellpadding=1 width=100%>");
				out.write("<tr> ");
		
				out.write("<td align=center width=10%  align=center bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Step/Row#</b></td>");
				out.write("<td align=center width=50% align=center bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Description</b></td>");
				out.write("<td align=center width=10% align=center bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Keyword</b></td>");
				out.write("<td align=center width=15% align=center bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Result</b></td>");
				out.write("<td align=center width=15% align=center bgcolor=#306791><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Screen Shot</b></td>");
				...
				if (description != null) {
					for (int i = 0; i < description.size(); i++) {
						...
						out.write("<td align=center width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>TS" + (i + 1) + "</b></td>");
						out.write("<td align=center width=50%><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>" + description.get(i) + "</b></td>");
						out.write("<td align=center width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>" + keyword.get(i) + "</b></td>");
						...
						if (screenShotPath.get(i) != null)
							...
							out.write("<td align=center width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>&nbsp;</b></td>");
						out.write("</tr>");
					}
				}
